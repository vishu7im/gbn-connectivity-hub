...
import { Building, MapPin, Calendar, Briefcase, ChevronLeft, ExternalLink, Clock } from "lucide-react";
      ...
      <main className="flex-grow">
        <div className="bg-[#0a2463] text-white py-8">
          <div className="container mx-auto px-4">
            <Link to="/jobs" className="inline-flex items-center text-white hover:text-[#e6c200] transition-colors">
              <ChevronLeft size={20} />
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Link to={`/members/${job.postedById}`} className="flex items-center mt-1 text-blue-600 hover:underline">
